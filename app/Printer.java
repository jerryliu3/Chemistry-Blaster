...
/** Helper class designed to make printing easier. Basic principle is that this class will act like an output stream allowing
  ...
  * @author Daniel Chen, javadoc modified by Isis So
  * @version 2.0
  */
...
/* Update notes:
 ...
 to println () which allows printing to different alignment (left, right, center). Added image printing which can print an image
 directly or resize it based a percentage of the paper's dimensions.
 WARNING: This class will not check for overlaps, make sure you predict the location of everything if you don’t want overlapping.
 */

public class Printer implements Printable 
{
  /**
   * The purpose of the <String> ArrayLists left, center and right are to store the text to be printed on the different alignments.
   */
  private ArrayList <String> left, center, right;
  /**
   * The purpose of the <BufferedImage> ArrayList images is to store the images to be printed.
   */
  private ArrayList <BufferedImage> images;
  /**
   * The purpose of the <Point> ArrayList imageLocations is to store the locations of the images to be displayed.
   */
  private ArrayList <Point> imageLocations;
  /**
   * The purpose of the <Boolean> ArrayList needsResizing is to store whether or not an image should be resized.
   */
  private ArrayList <Boolean> needsResizing;
  /**
   * The purpose of the<int []>ArrayList imageSizePercent is to store the percentage of the paper's dimensions the images takes up.
   */
  private ArrayList <int []> imageSizePercent;
  /**
   * The purpose of the private integer variable y is to keep track of which y-coordinate to display text on.
   */
  private int y;
  /**
   * The purpose of the final integer MARGINS is to store the default margins from the edge of the paper, 72 is the equivalent of 1 inch.
   */
  private final int MARGINS = 72;
  /**
   * The purpose of the private Font variable font is to store the font for the text to be printed.
   */
  private Font font;
  ...
  /**
   * Queues a String aligned on the left side to be printed. Adds the String to the left ArrayList and empty Strings to the others.
  ...
  /**
   * Queues a line with different text aligned on different places to be printed. Each String will be drawn starting at different locations.
   * The one on the left will be at the margins, the one in the center will be displayed with its center aligned with the
   * center of the page and the right most one will end on the right margin.
   * @param leftText This String variable stores the text that will be displayed on the left side.
   * @param centerText This String variable stores the text that will be centered.
   * @param rightText This String variable stores the text that will be displayed on the right side.
   */
  ...
  /**
   * Queues an image to be printed. <br> The image will be drawn at the location specified without any processing for if it goes off the page.
   ...
   * @param image This BufferedImage variable stores the image to be printed.
   * @param location This Point variable stores the location of the image. Syntax is: new Point (x, y).
   */
   ...
   * drawn at the location specified without any processing for if it goes off the page. Images will automatically be moved a bit to the
   ...
   * @param useWidth Boolean for whether to base the percent on width or height.
   * @param temp The purpose of the integer array temp is to store the size percent.
   */  
   ...
   * @param temp The purpose of the integer array temp is to store the size percent of the image.
   */  
   ...
   * up.
   * The purpose of the first if statement is to check if it can print.
   * @param p The purpose of the reference variable p is to reference the PrinterJob class to allow printing.
   * @return boolean representing whether or not the print was sucessful.
   * @exception PrinterException caught if any errors occur, causing print to be unsucessful.
   */
